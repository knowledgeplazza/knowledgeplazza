 ...
 *
 * Modified by Jackson Smith
 * The only important change is down near the bottom
 *
 */

// import {ChangeDetectorRef, OnDestroy, Pipe, WrappedValue} from '@angular/core';
import { ChangeDetectorRef, OnDestroy, Pipe, WrappedValue, EventEmitter } from '@angular/core';
...
export class AsyncPipe implements OnDestroy {
  ...
  private _updateLatestValue(async: any, value: Object) {
    if (async === this._obj) {
      ...
      // Force call to detectChanges. For some reason angular doesn't detect changes when we update our observables
      this._ref.detectChanges(); // This is the important change
    }
  }
}